...
SELECT COUNT(id_log), log_type FROM bot_logs WHERE DATE > '2024-06-29 00:00:00' AND DATE < '2024-06-29 23:59:59' GROUP BY log_type
...
-- MiudaReles      - Brazink.tnrq95.rev.vodafone.pt
...
SELECT * FROM bot_entradas WHERE HOST IN('Brazink.42981s.netvisao.pt');

SELECT * FROM bot_entradas WHERE nick = 'Leoa_PT'
